...
*   **The Intelligence is Inside:** Our local AI inference architecture is powered by the bundled **`llama.cpp`**. Drag in a model GGUF (and vision encoder or mtp GGUFs as applicable) and you have a local LLM that works in airgapped environments.
